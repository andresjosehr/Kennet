...
<script type="text/javascript" src="avs_emp_reg3.js"></script>
      ...
      <div class="col-md-6 contForm">
        <h1>Comentanos tu Experiencia</h1>
          <aside class="container">
           <form id="Frm" name="Frm" method="post" class="  colortransparente" action="avs_emp_reg3.php" enctype="multipart/form-data">            
              <div class="row emp_input">                  
                  <div class="col-md-12 col-xs-12">
         
                      <div class="form-group">
                        <label for="Exp">Apellido Paterno</label>
                        <input type="text" class="form-control" id="Apa" name="Apa" placeholder="">
                      </div>
                      <div class="emp_pago">
                          <div class="form-group">
                            <label for="Exp">Apellido Materno</label>
                            <input type="text" class="form-control" id="Ama" name="Ama" placeholder="">
                          </div> 
                      </div>
                  </div>
                  <div class="col-md-12 col-xs-12 emp_experiencia">
                          <h4>USTED FUMA</h4>
                          <div class="form-group">
                              <label for="Exp">USTED FUMA</label>
