...
include("avs_emp_reg3_cat1_fun.php");
...
<script type="text/javascript" src="avs_emp_reg3_cat1.js"></script>
                      ...
                      <div id="emp_colapsar_uno" class="collapse show" aria-labelledby="emp_cabecera_uno" data-parent="#emp_acordion">
                        <div class="card-body">
                              ...
                              <ul class="list-group">
                                    ...
                                    <li class="list-group-item active">Biografia</li>
                                </ul>
                        </div>
                      </div>
                    </div>
      ...
      <div class="col-md-6 ">
        <h1>Tu Biografía</h1>
          <aside class="container">
           <form id="Frm" name="Frm" method="post" class="  colortransparente" action="avs_emp_reg3_cat1.php" enctype="multipart/form-data">            
              <div class="row emp_input">                  
                  <div class="col-md-12 col-xs-12">
         
                      <div class="form-group">
                        <label for="Pti">Titulo del Perfil</label>
                        <input type="text" class="form-control" id="Pti" name="Pti" placeholder="">
                      </div>
                      <div class="emp_pago">
                          <div class="form-group">
                            <label for="Bio">Describe brevemente tu experiencia cuidando niños</label>
                            <textarea class="form-control" name="Bio" id="Bio" rows="6"><?php echo $Moti; ?></textarea>                            
                  ...
                  <div class="col-md-12 col-xs-12 emp_experiencia">
                      ...
                      <div class="form-group">
                        ...
                        <select name="Edu" id="Edu" class=" form-control" 
                            ...
                            <!--<?php echo FCBO("aux_nom","avs_auxiliar","id_aux>0 AND aux_tip='NIVE'",$Hdy,"N","S");?>-->
                             <option value="22">Primaria</option>
                           <option value="23">Secundaria Completa
</option>
                           <option value="24">Superior Terminado
</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Yex" name="Yex" placeholder="">
                      </div>                      
